...
if (is_user_logged_in()) {
  ...
  // Validate order_id (assuming it comes from $_GET or similar)
...
<div class="white-padding mb-4">
  <h2 class="mb-0"><?php echo esc_html__( 'Complete Service Details', 'prolancer' ); ?></h2>
</div>
...
<?php if ($result){ ?>
  ...
  $messages = []; // Initialize as empty array by default
